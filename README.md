...
| Project | Description |
|---------|-------------|
| [Defender for Servers P2 — Cost & Savings Analysis](defender-for-servers-p2-benefit/) | Compound KQL queries that calculate daily billable ingestion after the Defender for Servers P2 benefit, track actual savings, and surface per-table breakdowns for FinOps reporting. |
